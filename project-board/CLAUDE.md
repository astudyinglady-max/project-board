# CLAUDE.md — claude-commin-kit 프로젝트 지침

Claude Code가 이 프로젝트에서 작업할 때 반드시 읽고 준수해야 하는 규칙 문서입니다.
...
│   ├── 유저스토리.md          # 유저스토리 16개 + 수용 기준
│   └── 차별화.md             # 문제 정의, 기존 솔루션 한계, 강점
│
├── kit/                     # 로컬 CLI (프로젝트별 커스터마이징 가능)
│   └── cli.mjs              # Node.js CLI 진입점
│
├── .kit/                    # git submodule — 업스트림 원본
│   ├── kit/cli.mjs
│   └── docs/
│
